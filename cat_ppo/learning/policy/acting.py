...
class Evaluator:
    ...
    def __init__(
        ...
        self.debug = debug
        self.core_metric_names = core_metric_names
    ...
    def run_evaluation(
        ...
        # core
        # metrics["eval_core/avg_episode_length"] = np.mean(eval_metrics.episode_steps)
        # for k in self.core_metric_names:
        #     metrics[f"eval_core/{k}"] = np.mean(eval_metrics.episode_metrics[k])
